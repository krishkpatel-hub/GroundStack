...
1. Open the landing page and describe GroundStack as a grounded AI assistant for technical support.
2. Click an example question on the Ask page.
3. Submit the question and point out streaming progress states.
